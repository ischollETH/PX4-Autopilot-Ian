...
::: info
Flight termination only works if `drivers/pwm_input` is included in the default build for your board. If not, you need to add it manually via [boardconfig](../hardware/porting_guide_config.md#px4-menuconfig-setup)
:::
